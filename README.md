...
- Custom frameless builder window with a draggable title bar, rounded corners, and resize grip.
...
- Multi-monitor targeting with monitor checkboxes, topmost control, non-fullscreen window size slider, Relax Mode cat pre-roll, max-volume launch option, improved drag-and-drop handling, and clearer build/error reporting.
